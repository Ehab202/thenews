...
import 'SourcesResponce.dart';

class ArticlesResponce {
  String?massage;
  String?code;
  ArticlesResponce({
    this.massage,
  ...
  ArticlesResponce.fromJson(dynamic json) {
    _status = json['status'];
...
ArticlesResponce copyWith({  String? status,
  int? totalResults,
  List<Articles>? articles,
}) => ArticlesResponce(  status: status ?? _status,
