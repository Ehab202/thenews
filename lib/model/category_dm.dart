...
class CategoryDM{
  ...
  static List<CategoryDM> categories = [
    CategoryDM(id: "sports", title: "Sports",
        imagePath: "assets/ball.jpg", isLeftSided: true,
        backgroundColor: Colors.red[900]!),
    CategoryDM(id: "technology", title: "Technology",
        imagePath: "assets/Politics.jpg", isLeftSided: false,
        backgroundColor: Colors.blue[900]!),
    CategoryDM(id: "health", title: "Health",
        imagePath: "assets/health.jpg", isLeftSided: true,
        backgroundColor: Colors.pink),
    CategoryDM(id: "business", title: "Business",
        imagePath: "assets/bussines.jpg", isLeftSided: false,
        backgroundColor: Colors.orange[900]!),
    CategoryDM(id: "entertainment", title: "Entertainment",
        imagePath: "assets/environment.jpg", isLeftSided: true,
        backgroundColor: Colors.lightBlue),
    CategoryDM(id: "science", title: "Science",
        imagePath: "assets/science.jpg", isLeftSided: false,
